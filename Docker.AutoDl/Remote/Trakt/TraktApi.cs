    ...
    public class TraktApi : ITrackingApi
    {
        ...
        private async Task TryToDeviceAuthenticate()
        {
            ...
            if (device != null && device.IsValid)
            {
                ...
                {
                    SaveAuthToken(new TraktToken { AccessToken = authorization.AccessToken, RefreshToken = authorization.RefreshToken });
        ...
        private async Task RefreshAuthorization()
        {
            ...
            {
                SaveAuthToken(new TraktToken { AccessToken = newAuthorization.AccessToken, RefreshToken = newAuthorization.RefreshToken });
